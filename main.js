$(() => {
  searchCountries(
    "https://restcountries.eu/rest/v2/all?fields=name;topLevelDomain;capital;currencies;flag"
  );
      ...
      for (const country of countries) {
        ...
        $("main").append(`
              <div>
                  ...
                  <h4>Capital: <span class="light">${
                    country.capital
                  }</span></h4>
                  <h4>Domain: <span class="light">${
                    country.topLevelDomain
                  }</span></h4>
                  <h4>Currencies: <span class="light">${currencies.replace(
                    /undefined/g,
                    ""
                  )}</span></h4>
              </div>
